...
export class EventProjectWBW3__idToEventResult {
  value0: Bytes;
  value1: string;
  value2: Address;
  value3: BigInt;
...
export class EventProjectWBW3 extends ethereum.SmartContract {
  static bind(address: Address): EventProjectWBW3 {
    return new EventProjectWBW3("EventProjectWBW3", address);
  }

  idToEvent(param0: Bytes): EventProjectWBW3__idToEventResult {
    ...
    return new EventProjectWBW3__idToEventResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_idToEvent(
    param0: Bytes
  ): ethereum.CallResult<EventProjectWBW3__idToEventResult> {
    ...
    return ethereum.CallResult.fromValue(
      new EventProjectWBW3__idToEventResult(
        value[0].toBytes(),
        value[1].toString(),
        value[2].toAddress(),
        value[3].toBigInt(),
